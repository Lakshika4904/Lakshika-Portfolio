...
function openGmail() {
  const email = "lakshikakatariya04092004@gmail.com";
...
function downloadCV() {
  ...
  link.href = "Lakshika Resume.pdf"; // Path to your resume file
  link.download = "Lakshika Katariya Resume"; // Name for the downloaded file
